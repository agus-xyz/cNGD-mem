...
\begin{center}
\vspace*{1cm}
All the source files used for this document generation can be accessed at the public repository: \emph{https://github.com/agus-xyz/cNGD-mem}.
\end{center}
\end{small}
...
\bf Author:  & \sc \autor \\ \\
\bf Advisor: & \sc \tutor \\ \\
\bf Inspector: & \sc \ponente \\ \\
\bf Departament: & \sc \departamento \\
\end{tabular}
\bigskip
\vspace{0.7cm}
...
\bf President: & \sc D. \presidente   \\ \\
\bf Member: & \sc  D.  \vocal \\ \\
\bf Secretary: & \sc D. \secretario  \\ \\
\bf Assistant: & \sc D. \suplente \\ \\
\end{tabular}
...
It is certified that Agustín Tena García has successfully accomplished his Final Thesis Report, thus obtaining the M.S. Degree in Telecommunication Engineering at Higher Technical School of Telecommunication Engineering, Technical University of Madrid, Spain.
\end{tabular}
...
%\mbox{ } \\ \mbox{ } \\
%\textoSegundoSubtituloPortadaVal
\end{center}
\end{Large}
