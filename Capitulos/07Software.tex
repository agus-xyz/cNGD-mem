...
\item Unicast communication mode, to make sure of the right messages dispatching.
...
A video showing the demo application working can be accessed at \\ \emph{http://www.youtube.com/watch?v=-OZgtnSqlAM}. For better comfort, Figure \ref{fig:cap7:demovideo} provides access to the video.
