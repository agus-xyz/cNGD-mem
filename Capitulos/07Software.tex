...
Current and older versions of the firmware, along with small software related tests, can be found in the public GitHub repository at\\ \emph{https://github.com/agus-xyz/cognitiveNGD}. Figure \ref{fig:cap7:repoqr} provides a \ac{QR} code to instantly access the repository.
...
\item \emph{MANUAL\_PLATFORM}. This option gives freedom to the user to fully configure the employed hardware. Any of the possible MIWI and WIFI
