...
%\item The whole design is covered in Chapter 4. A modular design builds up the whole system. A total of three modules were designed. In general, less featured components compose the new system. Battery options were studied resulting in a final option of 3-cells \ac{NIMH} battery. Components were chosen and required functionalities assigned to different modules.

%\item At Chapter 5 is covered the hardware implementation. Size achieved is The \ac{PCB} layouts were deployed and prototypes mounted. Node functionalities were checked and design validation with consequent corrections.
