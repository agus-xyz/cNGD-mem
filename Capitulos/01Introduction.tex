...
against possible environmental incidents. However, there are also some challenges to face ****************** REF [4], specifically the study
of the sensing state, collaboration among devices or decision taking.  

Despite the potential of \ac{CWSNS}, they are not deeply explored yet. Real or simulated scenarios scarcely exist and 
...
three different transceivers, described in********REF******** and *******REF******* was created together with a \ac{HAL}. This firmware offers
...
in ************************ REF and it is a crucial progress for our goals.  
