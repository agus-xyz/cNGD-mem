...
Several other simulators have been developed for \ac{WSN}. TOSSIM based on the TinyOS operative system, COOJA, OPNET, GloMoSim, JSim, NetSIm or QualNet are more \ac{WSN} simulators without cognitive features despite some approaches and efforts to implement them.


%-------------------------------------------------------------------
\subsubsection{Test-bed platforms}
%-------------------------------------------------------------------
Focusing on CWSN devices, there are no specific platforms to develop WSN applications and services with cognitive 
