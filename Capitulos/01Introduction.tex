...
Since in many applications the number of used sensor nodes will be really high or they will be placed in a remote location, service of the nodes might not be possible.  In this case, the minimization of energy expenditure and cost is a requirement. This constraints affect the whole node operating mode, forcing the system to keep a low cost and resources (memory, computing capability, etc.) nature.
