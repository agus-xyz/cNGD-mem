...
The main goal of the project is to design and implement a node for a \ac{CWSN}. The implementation must meet strong efficiency, modularity and scalability requirements. A demo application layer, also to be developed, must integrate the already implemented \ac{HAL} and \ac{CRMODULE}. 
