...
{Simple relay network for a wireless network, vertices represent wireless connectivity, obtained from \cite{thomas}.}{Simple relay network for a wireless network.}
