...
\figura{Bitmap/Capitulo5/mtranstop}{width=0.15\textwidth}{fig:cap5:mtransfront}%
...
\subsection{Final result}
%-------------------------------------------------------------------
\figura{Bitmap/Capitulo5/cngdtop}{width=0.6\textwidth}{fig:cap5:cngdfront}%
...
\figura{Bitmap/Capitulo5/rs232bottom}{width=0.4\textwidth}{fig:cap5:rs232back}%
...
\subsection{Final results}
%-------------------------------------------------------------------
\figura{Bitmap/Capitulo5/chargertop}{width=0.4\textwidth}{fig:cap5:chargerfront}%
