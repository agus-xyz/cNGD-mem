...
In addition, the module contains a RS-232 male?********* connector to be connected to the computer or other device. Table \ref{tab:cap5:rs232components} details the components needed for this module. 
