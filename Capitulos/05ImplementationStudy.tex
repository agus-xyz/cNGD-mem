...
% caution because of its high current, a lot of debugging needed, first implementations were made over insercion placas.
%external power supply with current indicator, not in CNGD, 
% comparador module, try la comparacion

% fuente de tension luego

% probar con varias baterias, para comprobar diferencias de tension. el ajuste del dispositivo fue ardua pues hubo que retocar valores de resistencias, sobre todo calibrando.

% medir tiempos de carga, corrientes durante la carga, alerta de led, sincronizar.

%se prueba sobre cngd. 
