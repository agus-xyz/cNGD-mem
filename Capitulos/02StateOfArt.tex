...
a large variety of multicast and unicast protocols of both wireless and wired networks. Intesively used in wireless mobile Ad-hoc networks.

is a name for series of discrete event network simulators, specifically ns-1, ns-2 and ns-3. All of them are,  ns-3 is free software, publicly available under the GNU GPLv2 license for research, development, and use.
...
La versión actual, ns-3, esta diseñada para soportar todo el flujo de trabajo de la simulación desde la configuración hasta la recolección y análisis de tramas.
...
\figura{Vectorial/Capitulo2/ns3logo}{width=.3\textwidth}{fig:ns3logo}%
{NS3 Logo}


\item \emph{\ac{SENDORA}}.
