...
\subfloat[WirelessHART protocol logo]{\label{fig:cap2:hart}\includegraphics[width=0.2\textwidth]{Imagenes/Vectorial/Todo}}%
\quad
\subfloat[ISA100.11 protocol logo]{\label{fig:cap2:isa100}\includegraphics[width=0.2\textwidth]{Imagenes/Vectorial/Todo}}%
\quad
\subfloat[WiFi protocol logo]{\label{fig:cap2:wifi}\includegraphics[width=0.2\textwidth]{Imagenes/Vectorial/Todo}}%
\quad
\subfloat[MiWi protocol logo]{\label{fig:cap2:zigbee}\includegraphics[width=0.2\textwidth]{Imagenes/Vectorial/Todo}}%
