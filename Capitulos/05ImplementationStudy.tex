...
% modular design. main module -> main functions. attachable shields.

% no RI availables, se han diseñado 2 ad-hoc MRF49xa. un poco mas. soldadas.

% la otra en 2.4. un poco mas

% power supply opciones, headers, leds, botones, reset, control de power, clock, bateria, usb

% shield para rs232, debugging, traces, 

% charger shield, led, 200 mA 
