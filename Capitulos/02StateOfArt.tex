...
\item \emph{WaspMote}. It is an ultra low-power consumption a sensor node developed and marketed by Libelium\footnote{http://www.libelium.com} based on an ATmega1281 microcontroller. and an expansion board 
...
\figura{Vectorial/Capitulo2/waspmote}{width=.4\textwidth}{fig:waspmote}%
{Picture of Libelium WaspMote}
\item TmoteSky
\item SNE-ISMTV: VESNA
