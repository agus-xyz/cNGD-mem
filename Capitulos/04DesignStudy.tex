...
Therefore, the set of designs to carry out, showed at Figure \ref{fig:cap4:globalhw}, includes $\mu$Trans 434 and 868, \ac{CNGD}, rs232SHIELD and chargerSHIELD. All hardware design files can be freely accessed at a public GitHub\footnote{Web-based hosting service for software development projects that use the Git revision control system} repository: \\ \emph{https://github.com/agus-xyz/cNGD-hard}.
