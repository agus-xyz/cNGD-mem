...
\subfloat[Top view.]{\label{fig:cap5:mtransfront}\includegraphics[width=0.15\textwidth]{Imagenes/Bitmap/Capitulo5/mtranstop}}  
\qquad
\subfloat[Bottom view.]{\label{fig:cap5:mtransback}\includegraphics[width=0.4\textwidth]{Imagenes/Vectorial/Todo}}
...
\subfloat[Top view.]{\label{fig:cap5:cngdfront}\includegraphics[width=0.6\textwidth]{Imagenes/Bitmap/Capitulo5/cngdtop}}  
\qquad
\subfloat[Bottom view.]{\label{fig:cap5:cngdback}\includegraphics[width=0.4\textwidth]{Imagenes/Vectorial/Todo}}
...
\subfloat[Top view.]{\label{fig:cap5:rs232front}\includegraphics[width=0.4\textwidth]{Imagenes/Bitmap/Capitulo5/rs232top}}  
\qquad
\subfloat[Bottom view.]{\label{fig:cap5:rs232back}\includegraphics[width=0.4\textwidth]{Imagenes/Bitmap/Capitulo5/rs232bottom}}
...
\subfloat[Top view.]{\label{fig:cap5:chargerfront}\includegraphics[width=0.4\textwidth]{Imagenes/Bitmap/Capitulo5/chargertop}}  
\qquad
\subfloat[Bottom view.]{\label{fig:cap5:chargerback}\includegraphics[width=0.4\textwidth]{Imagenes/Vectorial/Todo}}
