...
\begin{itemize}
	...
	\item Serial Communication Modules allow flexible UART/SPI/I2C configuration. X***** \ac{UART}s, 4 \ac{SPI}s, and 5 {I2C}s included.  
	\item USB 2.0 On-The-Go Peripheral with integrated PHY.
	\item 10/100 Ethernet MAC with MII/RMII Interfaces. 
