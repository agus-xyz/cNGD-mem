...
The results show how the bottleneck is placed at \ac{RX} rate, which sets the maximum communication bit-rate between two devices around 25-30 kbps for all the \ac{RI}s.
