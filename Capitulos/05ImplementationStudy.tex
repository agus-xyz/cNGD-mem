...
\qquad
\subfloat[$\mu$Trans 434/868 PCB shape. ******* mm.]{\label{fig:cap5:mtransshape}\includegraphics[height=107px]{Imagenes/Vectorial/Capitulo5/mtransshape}}%
...
Module pads are based vias\footnote{A via is a electrical connection between layers in a physical electronic circuit that goes through the plane of one or more adjacent layers.}, with a 1.2 mm diameter through hole. These holes are width enouth let the solder tip into them and solder the pads over the footprint. These pads constitute the electrical interface between the $\mu$Trans and \ac{CNGD} and suppose a low-cost and size solution.  
...
\subsection{Layout}
%-------------------------------------------------------------------
Different layers of the layout can be obseved at Appendix \ref{ap2:layout}. Figures \ref{ap2:mtranstop} and \ref{ap2:mtransbottom} show the top and botton copper and silkscreen layers respectively.
...
\begin{figure}
        \centering
		\includegraphics[height=297px]{Imagenes/Vectorial/Capitulo5/cngdshape}  
...
\begin{figure}
        ...
        \caption{Header detail over cNGD PCB.}
        \label{fig:cap5:cngdheader}
\end{figure}
...
Headers module has been placed relying on the two upper long edges, Figure \ref{fig:cap5:cngdheader} shows it. Future expansion modules will be attached to this module through exctly equal headers on them, this way it will be possible to stack several expansion modules ones above others. The headers footprint to include in future expansion modules to fit the design is ilustrated in Figure \ref{fig:cap5:headerfootprint}.

\begin{figure}
        \centering
                \includegraphics[width=225px]{Imagenes/Vectorial/Capitulo5/headerfooprint}
        \caption{Header system footprint.}
        \label{fig:cap5:headerfootprint}
\end{figure}
...
\subsection{Layout}
%-------------------------------------------------------------------
Different layers of the layout can be obseved at Appendix \ref{ap2:layout}. Figures \ref{ap2:cngdtop} and \ref{ap2:cngdbottom} show the top and botton copper and silkscreens layers respectively.
%-------------------------------------------------------------------
\subsection{Prototype mounting and testing}
%-------------------------------------------------------------------
...
\subsection{Layout}
%-------------------------------------------------------------------
Different layers of the layout can be obseved at Appendix \ref{ap2:layout}. Figures \ref{ap2:rs232top} and \ref{ap2:rs232bottom} show the top and botton copper and silkscreen layers respectively.
%-------------------------------------------------------------------
\subsection{Prototype mounting and testing}
%-------------------------------------------------------------------
This module offers simplicity and does not require for much testing. Basically, the whole module is properly soldered and plugged into the \ac{CNGD} headers. Firmware must be configured to debug over the UART number 6. 
