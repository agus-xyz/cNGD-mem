...
After carrying out all the exposed tasks, conclusions about viability, valuability and utility about the implemented device came out. Most important points are:
...
\item Power switches driven by the \ac{MCU} control the power supply at the \ac{RI}s. These have been shown as a really valuable function at energy saving modes. Sleeping modes are succesfully implemented and allow a great autonomy using the provided batery. On the other hand, \ac{RI}s have shown a very low power consumption behaviour, what also helps to extend the autonomy.
