...
%-------------------------------------------------------------------
%PORQUE QUEREMOS QUE CARACTERISTICAS
...
%-------------------------------------------------------------------
The power control to the \ac{RI}s is based on the ADG701**** REF. This is a  CMOS \ac{SPST} switch
...
OFF
12 ns
Typical power consumption < 0.01 microW 

% PIN DIAGRAM Y DESCRIPCION
...
\figura{Vectorial/Todo}{width=.3\textwidth}{fig:cap4:oscillators}%
{PIC32MX675F256L oscillator input.}
